...
class Blueprint
{
	...
	public function tinyInteger(string $column, int $length = 4)
	{
		$this->columns[] = $column . ' TINYINT(' . $length . ')';
		return $this;
	}

	public function unsignedBigInteger(string $column, int $length = 20)
	{
		$this->columns[] = $column . ' BIGINT(' . $length . ') UNSIGNED';
		return $this;
	}

	public function unsignedMediumInteger(string $column, int $length = 8)
	{
		$this->columns[] = $column . ' MEDIUMINT(' . $length . ') UNSIGNED';
		return $this;
	}

	public function unsignedSmallInteger(string $column, int $length = 6)
	{
		$this->columns[] = $column . ' SMALLINT(' . $length . ') UNSIGNED';
		return $this;
	}

	public function unsignedTinyInteger(string $column, int $length = 4)
	{
		$this->columns[] = $column . ' TINYINT(' . $length . ') UNSIGNED';
		return $this;
	}
	...
	public function bigIncrement(string $column): Blueprint
	{
		$this->columns[] = $column . ' BIGINT(20) UNSIGNED AUTO_INCREMENT PRIMARY KEY';
		return $this;
	}
